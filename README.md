...
# 📖 [Microverse_Portfolio_Project] <a name="about-project"></a>

**[Microverse_Portfolio_Project]** is a Figma to HTML CSS project to learn how to parse Figma template to HTML CSS, Flexbox & Mobile first design approach.
...
> Checkout the live version of website here.

- [Live Demo Link](https://hmunish.github.io/microverse-portfolio/)
...
```sh
  cd my-folder
  git clone https://github.com/hmunish/microverse-portfolio.git
```
...
Feel free to check the [issues page](https://github.com/hmunish/microverse-portfolio/issues).
